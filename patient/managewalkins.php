...
<head>
    ...
    <title>Employer - Manage Walkins</title>
...
<body>
            ...
            <div class="container-fluid my-1">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0 gap-1">
                        <li class="nav-item">
                            <a class="nav-link text-primary" href="managejobs.php">Manage Jobs</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-primary-emphasis text-decoration-underline tug-2 active" aria-current="page" href="managewalkins.php">Manage Walkins</a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="row bg-white border-primary-subtle border border-1-5 rounded-2">
                    <div class="col-md-12">
                        ...
                        <h5 class="gap-2 d-flex my-3 rounded-2 p-3 align-items-center bg-primary-subtle text-primary-emphasis">
                            <i class="fa-solid fa-bars"></i> Add Walkin
                        </h5>

                        <form action="deletewalkin.php" method="post" id="deletewalkinform"></form>

                        <form action="savewalkin.php" method="post" id="savewalkinform">
                            ...
                            <div class="row justify-content-evenly g-3 mt-2">
                                ...
                                <div class="col-md-5">
                                    <div class="my-1 position-relative">
                                        ...
                                        <input type="date" name="date" id="date" placeholder="Date" class="form-control py-2 shadow-none">
                                        <div class="invalid-tooltip rounded-3">
                                            * Enter Date
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-5">
                                    <div class="my-1 position-relative">
                                        ...
                                        <input type="time" name="time" id="time" placeholder="Time" class="form-control py-2 shadow-none">
                                        <div class="invalid-tooltip rounded-3">
                                            * Enter Time
                                        </div>
                                    </div>
                                                    ...
                                                    <tr class="align-middle text-nowrap">
                                                        ...
                                                        <td>
                                                            <div class="form-group">
                                                                <button class="btn btn-danger btn-sm delete text-white shadow-none" id="butdel" name="butdel" form="deleteinstructorform" value="<?= $row["uid"] ?>">
    ...
    <script>
        $(function() {
            ...
            $("#savewalkinform").on("submit", function(e) {
                debugger;
