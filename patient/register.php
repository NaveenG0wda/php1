...
<body>
        ...
        <div class="container-fluid flex-fill d-flex">
            <div class="row ">
                <div class="col-md-5 d-flex align-items-center">
                    ...
                    <form method="post" action="savepatient.php" id="savepatientform">

                        <div class="row justify-content-center">
                            <div class="col-md-10 mt-4 mb-3">
                                <h4 class="text-center text-decoration-underline tug-1 text-primary-emphasis">Patient Register</h4>
                            </div>
    ...
    <script>
        $(function() {
            ...
            $("#savepatientform").on("submit", function(e) {
                debugger;
