...
<body>
            ...
            <div class="container-fluid my-1 mx-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0 gap-1">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-primary-emphasis fw-bold" href="index.php">Login</a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="container-fluid flex-fill d-flex">
            <div class="row ">
                <div class="col-md-5 d-flex align-items-center">
                    ...
                    <form method="post" action="savedoctor.php" id="savedoctorform">

                        <div class="row justify-content-center">
                            <div class="col-md-10 mt-4 mb-3">
                                <h4 class="text-center text-decoration-underline tug-1 text-primary-emphasis">Doctor Register</h4>
                            </div>
                            ...
                            <div class="col-md-10 my-1 position-relative">
                                <label for="phone" class="form-label">Specialization :</label>
                                <select name="specialization" id="specialization" class="form-select shadow-none text-capitalize border border-secondary">
    ...
    <script>
        $(function() {
            ...
            $("#savedoctorform").on("submit", function(e) {
                debugger;
